"""rebuild cirium.asg / cirium.delta: current = 3 latest revisions, old = all the rest
...
WITH
    ...
    old_inactive AS (
        SELECT DISTINCT ON (o.revision_id, o."Registration", o."Serial Number") o.id AS source_id, o.*
